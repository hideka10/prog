...
try {
    ...
    $pdo = new PDO('mysql:dbname=map_db;charset=utf8;host=localhost','
root','root');
...
<script src='https://www.bing.com/api/maps/mapcontrol?callback=GetMap&key=Ajg_-bZ889xSFt6OADPCCXXRpiwb1xNdWg0bkqmjYIviZvdNXnfg0nRoiE5QV-0R
 async defer></script>
...
function GetMap(){
    //BingMapスタート
    map = new Bmap("#myMap");
    map.startMap(47.6149, -122.1941, "load", zoom); //The place is 
Bellevue.
